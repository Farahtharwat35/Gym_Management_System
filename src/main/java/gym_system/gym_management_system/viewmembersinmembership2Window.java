...
public class viewmembersinmembership2Window extends JFrame{
    private JComboBox comboBox1;
    private JButton searchButton;
    private JTextPane textPane1;
    private JButton backToMenuButton;
    private JPanel viewmembersinmembership2Panel;
    ...
    viewmembersinmembership2Window() {

        setContentPane(viewmembersinmembership2Panel);
